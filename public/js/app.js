...
_reactDom2.default.render(React.createElement(App, null), document.getElementById('container')); // const ws = new WebSocket(`ws://${window.location.host}/ws?id=${window.chat_room_id}`);
